// Comes from https://www.reddit.com/r/Bitburner/comments/7n78l0/what_server_i_need_to_hack_for_run4theh111z/
// made by /u/CttCJim
...
export async function main(ns) {
    ...
    function showmap(server = 'home', lastserver = 'home', levels = 0, hidebig = false, target: string | null = null) {
